...
% Use nodal coordinates to compute largest element side and largest
% diagonal
if dim==2
    FE.max_elem_side = max([vecnorm(n2-n1) vecnorm(n3-n2) ...
        vecnorm(n4-n3) vecnorm(n1-n4)]);
    FE.max_elem_diag = max([vecnorm(n3-n1) vecnorm(n4-n2)]);
elseif dim==3
    FE.max_elem_side = max([vecnorm(n2-n1) vecnorm(n3-n2), ...
        vecnorm(n4-n3) vecnorm(n1-n4) vecnorm(n6-n5) vecnorm(n7-n6) ...
        vecnorm(n8-n7) vecnorm(n5-n8) vecnorm(n5-n1) vecnorm(n6-n2) ...
        vecnorm(n7-n3) vecnorm(n8-n4)]);
    FE.max_elem_diag = max([vecnorm(n7-n1) vecnorm(n8-n2) ...
        vecnorm(n5-n3) vecnorm(n6-n4)]);
end
